...
def count_words(phrase):
    ...
    return word_counts
    # word_counts = {word: word_counts.get(word, 0) + 1 for word in phrase.split()}
    # return word_counts
...
def word_length_sorted(words):
    ...
    # return sorted[word_length.get(len(word), []) + [word] for word in sorted(words)]
